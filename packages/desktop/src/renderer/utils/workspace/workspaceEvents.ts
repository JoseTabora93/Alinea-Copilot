export const WORKSPACE_TOGGLE_EVENT = 'alinea-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'alinea-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'alinea-workspace-has-files';
