...
const UsageSettings = React.lazy(() => import('@renderer/pages/settings/UsageSettings'));
...
const Projects = React.lazy(() => import('@renderer/pages/projects'));
    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route path='/projects/:id' element={withRouteFallback(Projects)} />
        </Route>
